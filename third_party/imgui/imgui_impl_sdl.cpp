...
//  2020-02-20: Inputs: Fixed mapping for ImGuiKey_KeyPadEnter (using
//  SDL_SCANCODE_KP_ENTER instead of SDL_SCANCODE_RETURN2). 2019-12-17: Inputs:
//  On Wayland, use SDL_GetMouseState (because there is no global mouse state).
